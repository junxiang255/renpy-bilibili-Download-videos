...
define config.name = _("renpy bilibili Download videos")
...
define gui.about = _p("""
{b}项目名称：{/b}Ren'Py Bilibili 视频下载工具

{b}作者：{/b}俊翔不会玩

{b}项目简介：{/b}
这是一个基于Ren'Py引擎开发的图形化工具，专门用于下载Bilibili（B站）平台/快手的视频内容。将下载功能与视觉小说引擎相结合。
\n{b}注意事项：{/b}
\n• 请仅下载用于个人学习、研究和欣赏的视频
\n• 尊重UP主/主播的创作成果，遵守Bilibili/快手用户协议
\n• 下载后请勿用于商业用途或非法传播
\n• 确保遵守相关版权法律法规
\n{size=14}{color=#888888}注：本工具为开源项目，仅供学习交流使用。{/color}{/size}""")


## 在构建的发布版中，可执行文件和目录所使用的短名称。此处仅限使用 ASCII 字符，
## 并且不能包含空格、冒号或分号。

define build.name = "bilibili"
...
define config.save_directory = "bilibili-1767412283"
